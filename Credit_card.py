#Provjeriti validnost kartice pomoću Luhnovog algoritma
...
def Algoritam(n):
    ...
    b=n//10
    lista=[]
    #Razdvajanje cifri u listu, osim kontrolne
    for i in range(0,len(str(b))):
        c=b%10
        d=b//10
        b=d
        lista.append(c)
    #Udvostručavanje vrijednosti svake druge cifre uz poštivanje 2. koraka
    #Luhnovog algoritma
